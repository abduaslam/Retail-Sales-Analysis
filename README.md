...
An interactive dashboard was built using Tableau Public to analyze sales performance and customer behavior.
### Key Insights
Top revenue is generated by leading product categories such as Electronics and Clothing.
Online sales outperform offline transactions.
Sales vary across months, indicating seasonal trends.
Digital payment methods are the most commonly used
